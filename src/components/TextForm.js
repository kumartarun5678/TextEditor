...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            <h1 className='mb-4'>TextEditor - word counter, character counter, remove extra spaces</h1>
            <div className="mb-3"> 
        ...
        <div className="container my-3 " style={{color: props.mode==='dark'?'white':'#042743', textAlign:'center'}}>
            <h2 color='white'>Your text summary</h2>
